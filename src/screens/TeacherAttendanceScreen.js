    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={onClose}>
      <Pressable style={styles.modalBackdrop} onPress={onClose}>
        <View style={styles.modal} onStartShouldSetResponder={() => true}>
          ...
          {options.map((option) => (
            <Pressable key={option} style={[styles.modalOption, option === value && styles.modalOptionActive]} onPress={() => { onSelect(option); onClose(); }}>
  ...
  const renderDailyLog = () => (
    <>
      <View style={styles.filterCard}>
        ...
        <Pressable style={styles.selectButtonFull} onPress={() => setSelecting('class')}><Text style={styles.selectText}>Select an option (Class)</Text><Icon name="chevron-down" size={16} color={colors.muted} /></Pressable>
        <Pressable style={styles.selectButtonFull} onPress={() => setSelecting('section')}><Text style={styles.selectText}>Select an option (Sections)</Text><Icon name="chevron-down" size={16} color={colors.muted} /></Pressable>
      </View>
