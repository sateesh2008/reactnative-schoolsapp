...
export default function TeacherExamsMarksScreen({ session, module = 'Exams / Marks', onSelectModule, onBack }) {
  ...
  if (activeModule === 'Hall Ticket') {
    return <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 40 }}><HallTicketScreen onBack={() => onSelectModule && onSelectModule('Exams / Marks')} /></ScrollView>;
  }
