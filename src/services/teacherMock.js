...
export const teacherDashboardData = {
  ...
  shortcuts: [
    {
      title: "Attendance",
      description: "Today’s class reports",
      icon: "calendar-outline",
      target: "Attendance",
    },
    {
    ...
    {
      title: "Grade Exams",
      description: "Evaluate marks",
      icon: "create-outline",
      target: "Exams / Marks",
    },
    {
      title: "My Schedule",
      description: "Faculty timetable",
      icon: "time-outline",
      target: "Timetable",
    },
    {
